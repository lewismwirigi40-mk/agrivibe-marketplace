...
export default function DriverProfile() {
  ...
  const stats = [
    { label: 'Total Deliveries', value: '156', icon: Truck, color: 'from-blue-500 to-blue-600' },
    { label: 'Completion Rate', value: '98%', icon: CheckCircle, color: 'from-green-500 to-emerald-500' },
    { label: 'Avg Rating', value: '4.8', icon: Star, color: 'from-yellow-500 to-orange-500' },
    { label: 'Active Hours', value: '1,247', icon: Clock, color: 'from-purple-500 to-purple-600' },
  ];
  ...
  return (
    <DriverLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'View Deliveries', icon: Truck, color: 'bg-blue-50 text-blue-600' },
            { label: 'Earnings', icon: Wallet, color: 'bg-green-50 text-green-600' },
