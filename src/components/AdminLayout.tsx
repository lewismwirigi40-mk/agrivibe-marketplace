...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    const checkAuth = async () => {
      try {
        ...
        setQuickStats({
          ...
          totalRevenueChange: stats.revenueChange || "+0%",
          activeUsers: stats.activeUsers || 0,
          activeUsersChange: stats.usersChange || "+0%",
          pendingOrders: stats.pendingOrders || 0,
          pendingOrdersChange: stats.ordersChange || "+0%",
        });
        ...
        setBadgeCounts({
          ...
          unanswered: stats.unansweredQuestions || 0,
        });
      } catch (error) {
  ...
  const navItems = [
    ...
    { name: "Vendors", href: "/admin/vendors", icon: Store, badge: null },
    {
      ...
      href: "/admin/products",
      icon: Package,
      badge: badgeCounts.products > 0 ? badgeCounts.products.toString() : null,
    },
    {
      name: "Orders",
      href: "/admin/orders",
      icon: ShoppingBag,
      badge: badgeCounts.orders > 0 ? badgeCounts.orders.toString() : null,
    },
    {
      name: "Payments",
      href: "/admin/payments",
    ...
    { name: "Guides", href: "/admin/guides", icon: BookOpen, badge: null },
    {
      ...
      icon: HelpCircle,
      badge:
        badgeCounts.unanswered > 0 ? badgeCounts.unanswered.toString() : null,
    },
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center flex-1 max-w-md mx-8">
              <div className="relative w-full">
                ...
                />
                <kbd className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400 bg-gray-200 dark:bg-white/10 px-2 py-1 rounded-lg">
                  ⌘K
                </kbd>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  change: quickStats.totalRevenueChange,
                  icon: TrendingUp,
                ...
                },
                {
                  ...
                  change: quickStats.activeUsersChange,
                  icon: Users,
                  color: "text-blue-500",
                },
                {
                  ...
                  change: quickStats.pendingOrdersChange,
                  icon: Clock,
      ...
      {/* ====== MAIN CONTENT ====== */}
      <main
        className={`pt-16 lg:pt-20 transition-all duration-300 ${isSidebarOpen ? "lg:ml-72" : "lg:ml-72"}`}
      >
