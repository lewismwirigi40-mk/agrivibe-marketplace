...
export default function DriverLayout({ children }: DriverLayoutProps) {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'New delivery assigned #DEL-004', time: '5 min ago', read: false },
    { id: 2, title: 'Payment received KES 150', time: '2 hours ago', read: false },
    { id: 3, title: 'Delivery #DEL-003 completed', time: '5 hours ago', read: true },
  ]);
  ...
  const navItems = [
    { name: 'Dashboard', href: '/driver/dashboard', icon: LayoutDashboard, badge: null },
    { name: 'My Deliveries', href: '/driver/deliveries', icon: Package, badge: '2' },
    { name: 'Profile', href: '/driver/profile', icon: User, badge: null },
  ];

  const quickStats = [
    { label: 'Today\'s Deliveries', value: '5', icon: Truck, color: 'text-blue-500' },
    { label: 'Completed', value: '3', icon: CheckCircle, color: 'text-green-500' },
    { label: 'Earnings', value: 'KES 450', icon: DollarSign, color: 'text-yellow-500' },
  ];
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/driver/dashboard" className="flex items-center gap-3 group">
                <motion.div
                ...
                <div className="hidden sm:block">
                  ...
                  <span className="block text-[10px] text-gray-400 font-medium tracking-widest uppercase">Driver Portal</span>
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2">
                  ...
                  {activeDropdown === 'notifications' && (
                    ...
                    >
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {notifications.map((n) => (
                          <div key={n.id} className={`p-4 border-b border-gray-50 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors ${!n.read ? 'bg-blue-500/5' : ''}`}>
              ...
              <AnimatePresence>
                {activeDropdown === 'profile' && (
                  ...
                  >
                    <div className="p-4 border-b border-gray-100 dark:border-white/10">
                      <p className="font-bold text-gray-900 dark:text-white">Driver</p>
                      <p className="text-xs text-gray-400">driver@agrivibe.com</p>
                    </div>
                    <div className="p-2">
                      <Link href="/driver/profile" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition-colors text-gray-700 dark:text-gray-300">
                        <User className="w-4 h-4" />
                        <span>Profile</span>
                      </Link>
                      <Link href="/driver/settings" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition-colors text-gray-700 dark:text-gray-300">
          ...
          <nav className="flex-1 p-4 space-y-1">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-5 h-5 ${isActive ? 'text-blue-500' : 'group-hover:text-gray-900 dark:group-hover:text-white'}`} />
          ...
          <div className="p-4 border-t border-gray-100 dark:border-white/10">
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-2xl p-4 border border-blue-500/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm font-bold text-gray-900 dark:text-white">Top Driver</span>
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">You've completed 156 deliveries</p>
        ...
        <footer className="border-t border-gray-200/20 dark:border-white/10 px-6 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-400">
              <Link href="/driver/dashboard" className="hover:text-blue-500 transition-colors">Dashboard</Link>
              <Link href="/driver/deliveries" className="hover:text-blue-500 transition-colors">Deliveries</Link>
              <Link href="/driver/profile" className="hover:text-blue-500 transition-colors">Profile</Link>
